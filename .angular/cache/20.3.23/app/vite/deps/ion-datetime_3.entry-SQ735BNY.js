...
`, this.el);
  ...
  render() {
    ...
    })) }, h("div", { key: "3edc567b8d6cefb3af3be0b6008322daeed52e94", class: "intersection-tracker", ref: (el2) => this.intersectionTrackerRef = el2 }), this.renderDatetime(mode));
  }
  get el() {
...
var PickerColumnCmp = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./index-CfgBF1SE-E5UB6Q2U.js")).createGesture({
        el: this.el,
...
//# sourceMappingURL=ion-datetime_3.entry-SQ735BNY.js.map
